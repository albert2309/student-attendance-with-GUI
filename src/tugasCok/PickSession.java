 ...
 * @author Albert
 */
public class PickSession extends javax.swing.JFrame {

    /**
     * Creates new form ModifySession
     */
    public PickSession(String id) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     boolean error = false;
        ...
        ModifyAttendance y = new ModifyAttendance(selectedSession,lecturerID, selectedModuleCode, selectedModuleName, selectedIntakeCode, selectedStartTime, selectedEndTime, selectedDate, selectedStudentList);
        y.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PickSession.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PickSession("L-0").setVisible(true);
            }
        });
    }
